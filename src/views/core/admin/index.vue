    ...
    <UViewDrawer width="780" layout="vertical" :rules="rules" placement="left" title="用户管理" @edit="editOpen">
      <template #default="{model}">
        <URow :gutter="16" col="drawer">
          <UInputItem field="account" label="用户帐号" :disabled="model.id != null"/>
          <UInputItem field="name" label="用户昵称" required/>
          ...
          <UInputItem field="phone" label="用户手机" />
          <UInputItem field="email" label="用户邮箱" />
          ...
          <UTextareaItem field="remark" label="用户简介" :span="24" />
        </URow>
      </template>
