...
function resolverOptions(data, labelField, valueField, targetLabelField, targetValueField, valueLabelMap, valueModelMap) {
  data.forEach((item) => {
    ...
    if (item.children instanceof Array) {
      resolverOptions(item.children, labelField, valueField, targetLabelField, targetValueField, valueLabelMap, valueModelMap)
    }
  })
}
  ...
  store.registerModule('sys', {
    ...
    getters: {
      ...
      getOptionsByUrl: (state) => {
        return (url, labelField, valueField, targetLabelField, targetValueField) => {
